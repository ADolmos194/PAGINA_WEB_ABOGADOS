...
import PDF_SocioRenzoInga from "@assets/pdf/socios/RENZO-INGA-MIRANDA.pdf"
export const RenzoIngaMiranda = () => {
                    ...
                    <div class="wp_center wp_flexbox-top">
                        <div class="column-left-staff">
                            <div class="row-image-staff">
                                <img src={SocioRenzoInga} alt="SocioRenzoInga" />
                            </div>
                            <a href="/abogados">Volver</a>
                        </div>
                        <div class="column-right-staff">
                            <h2>Renzo Inga Miranda</h2>
                            <span>Socio Fundador
                            </span>
                            <div class="data-staff">
                                <ul>
                                    <li>renzo_inga@fobego.com.pe
                                    </li>
                            ...
                            <div class="theContent-staff">
                                <p>Asuntos corporativos, administrativos, judiciales, comerciales, laborales derecho de Consumidor, patente y marcas, legislación educativa y protección de datos personales.</p>
                                <p>Idiomas: español e inglés.</p>
                            </div>

                            <a href={PDF_SocioRenzoInga} target="_blank" rel="noopener noreferrer" class="button-pdf">Descargar CV </a>
