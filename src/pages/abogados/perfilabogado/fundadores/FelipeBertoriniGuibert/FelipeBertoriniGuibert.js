...
import PDF_FundadorFelipeBertorini from "@assets/pdf/fundadores/FELIPE-MANUEL-BERTORINI-GUIBERT.pdf";


export const FelipeBertoriniGuibert = () => {
                ...
                <div id="wp_container_staff">
                    <div class="wp_center wp_flexbox-top">
                        ...
                        <div class="column-right-staff">
                            ...
                            <a href={PDF_FundadorFelipeBertorini} target="_blank" rel="noopener noreferrer" class="button-pdf">Descargar CV </a>
