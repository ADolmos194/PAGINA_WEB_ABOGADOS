...
import PDF_FundadorFernandoFort from "@assets/pdf/fundadores/FERNANDO-FORT-MARIE.pdf";

export const FernandoFortMarie = () => {
                ...
                <div id="wp_container_staff">
                    <div class="wp_center wp_flexbox-top">
                        ...
                        <div class="column-right-staff">
                            ...
                            <a href={PDF_FundadorFernandoFort} target="_blank" rel="noopener noreferrer" class="button-pdf">Descargar CV </a>
