...
export const Actosinscritosmedianteplataformaidsunarp2021 = () => {
    ...
    return (<>
        ...
        <section>
            ...
            <div id="wp_container_post-Single">
                <div class="wp_center">
                    <div class="data-post">
                        <span>23.02.2021</span>
                        <h2>Actos que deben ser inscritos mediante la plataforma SID- SUNARP 2021</h2>
                    </div>
                    <div class="image-post">

                        <img src={imange_noticia1} alt="" />
                    </div>
                    <div class="text-post">
                        <p>Con fecha 05 de Junio del año en curso, ha sido publicado en el Diario Oficial el peruano, la Resolución de la Superintendencia Nacional De Los Registros Públicos N° 052-2021-SUNARP/SN, (en adelante, la “Resolución”), mediante la cual establece que a partir del día 09 de junio del año en curso, deberán presentarse los siguientes actos a través de la plataforma SID-SUNARP:</p>
                        <p>Actos correspondientes al registro de personas jurídicas.</p>
                        <p>-Modificación de estatutos (con excepción del cambio de domicilio a una oficina registral distinta a aquella en la que consta inscrita la persona jurídica, así como la fusión, escisión y reorganización simple), de Sociedad Anónima (S.A.), Sociedad Anónima Cerrada (S.A.C.), Sociedad Comercial de Responsabilidad Limitada (SRL) y Empresa Individual de Responsabilidad Limitada (E.I.R.L.).</p>
                        <p>-Transferencia de participaciones por actos intervivos de Sociedad Comercial de Responsabilidad Limitada (SRL).</p>
                        <p>Actos correspondientes al reegistro de predios.</p>
                        <p>-Compraventa.</p>
                        <p>-Constitución de hipoteca.</p>
                        <p>-Ampliación, reducción, modificación o levantamiento de hipoteca.</p>
                        <p>Ahora bien, es importante destacar que la Resolución hace mención a ciertos actos que se encuentran excluidos de los alcances de la misma, dentro de los cuales se encuentran:</p>
                        <p>-Los traslados instrumentales expedidos por cónsules cuando ejercen función notarial fuera del país o aquellos instrumentos otorgados fuera del territorio nacional, conforme al régimen legal extranjero.</p>
                        <p>-Los traslados instrumentales expedidos por el Archivo General de la Nación o por los Archivos Departamentales, correspondientes al acervo documentario del notario cesado.</p>
                        <p>-Las resoluciones emitidas por los órganos jurisdiccionales o arbitrales.</p>
                        <p>-Las solicitudes de inscripción que, conteniendo cualquiera de los actos señalados en la presente resolución, incorporen otros actos inscribibles cuya presentación, a través del SID-SUNARP, es facultativa.</p>
                        <p>-Traslados instrumentales del acervo documentario del notario cesado, cuyo protocolo notarial se encuentra bajo la administración de los Colegios de Notarios, manteniéndose para estos casos la presentación facultativa.</p>
                    </div>
                    <div class="row-social">
                        <div class="button-prev-single">
                            <a href="/blog/">Volver</a>
                        </div>
                        <div class="row-social-share">
                            <Link href="" class="openPopupShare" target="popup"></Link>
                            <Link href="" class="openPopupShare" target="popup"></Link>
                            <Link href="" class="openPopupShare" target="popup"></Link>
                        </div>
                    </div>
