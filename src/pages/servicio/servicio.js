                        ...
                        <div class="field-lang-movil">
                            <div class="menu-idiomas-container">
                                <ul id="menu-idiomas-1" class="menu">
                                    <li class="qtranxs-lang-menu qtranxs-lang-menu-es menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-193">
                                        <Link href="#" title="Esp /">Language Menu:&nbsp;<img src="https://ambientedepruebas.net/fobego/wp-content/plugins/qtranslate-x/flags/es.png" alt="Esp /" /></Link>
                                        <ul class="sub-menu">
                                            <li class="qtranxs-lang-menu-item qtranxs-lang-menu-item-es menu-item menu-item-type-custom menu-item-object-custom menu-item-194"><a href="https://ambientedepruebas.net/fobego/es/" title="Esp /"><img src="https://ambientedepruebas.net/fobego/wp-content/plugins/qtranslate-x/flags/es.png" alt="Esp /" />&nbsp;Esp /</a></li>
                                            <li class="qtranxs-lang-menu-item qtranxs-lang-menu-item-en menu-item menu-item-type-custom menu-item-object-custom menu-item-195"><a href="https://ambientedepruebas.net/fobego/en/" title="Eng"><img src="https://ambientedepruebas.net/fobego/wp-content/plugins/qtranslate-x/flags/gb.png" alt="Eng" />&nbsp;Eng</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <nav>
                            <div class="menu-menu-container">
                                <ul id="menu-menu-1" class="menu">
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-124"><a href="https://ambientedepruebas.net/fobego/estudio/">Estudio</a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-131"><a href="https://ambientedepruebas.net/fobego/nuestros-abogados/">Abogados</a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-139"><a href="https://ambientedepruebas.net/fobego/nuestros-servicios/">Servicios</a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-163"><a href="https://ambientedepruebas.net/fobego/blog/">Blog</a></li>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-169"><a href="https://ambientedepruebas.net/fobego/contactanos/">Contacto</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                        ...
                        <ul>
                            <li>
                                <div class="image-services">
                                    <i>01</i>
                                    <img src="https://ambientedepruebas.net/fobego/wp-content/uploads/2021/02/servicio-1.jpg" alt="" />
                                </div>
                            ...
                            <li>
                                <div class="image-services">
                                    <i>02</i>
                                    <img src="https://ambientedepruebas.net/fobego/wp-content/uploads/2021/06/Derecho-tributario_En-formato.jpg" alt="" />
                                </div>
                                <div class="content-services">
                                    <div>
                            ...
                            <li>
                                <div class="image-services">
                                    <i>03</i>
                                    <img src="https://ambientedepruebas.net/fobego/wp-content/uploads/2021/02/servicio-3.jpg" alt="" />
                                </div>
                                <div class="content-services">
                                    <div>
                            ...
                            <li>
                                <div class="image-services">
                                    <i>04</i>
                                    <img src="https://ambientedepruebas.net/fobego/wp-content/uploads/2021/06/Propiedad-intelectual-2_En-formato.jpg" alt="" />
                                </div>
                                <div class="content-services">
                                    <div>
                        ...
                        <div class="wp_link_Footer">
                            <div class="menu-pie-de-pagina-container">
                                <ul id="menu-pie-de-pagina" class="menu">
                                    <li id="menu-item-109" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-109"><Link href="#">Términos &#038; Condiciones</Link></li>
                                    <li id="menu-item-110" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-110"><Link href="#">Privacidad</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
